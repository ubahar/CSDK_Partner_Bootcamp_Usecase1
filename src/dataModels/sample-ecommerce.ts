...
interface aggTableDimension extends Dimension {
    AgeRange: Attribute;
    Column: Attribute;
}
export const aggTable = createDimension({
    name: 'aggTable',
    AgeRange: createAttribute({
        name: 'AgeRange',
        type: 'text-attribute',
        expression: '[aggTable.Age Range]',
    }),
    Column: createAttribute({
        name: 'Column',
        type: 'numeric-attribute',
        expression: '[aggTable.Column]',
    }),
}) as aggTableDimension;
